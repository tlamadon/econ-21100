...
$$
The individual takes his wage $w$ as given, he chooses hours of work $h$ and consumption $c$ subject to a given non labor income $\mu$ as well as a tax regime defined by $\rho,r$. $\beta_0$ is a fixed cost associated with working. We ignore participation here, see the homework for including it.
...
This suggests an IV strategy where we instrument using $W,R,X$. We then first regress $h$ and $c$ on these thre varaibles to get the predicted component, that we then use in a regression.
